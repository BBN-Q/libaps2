...
const uint8_t DAC_CONTROLLER_ADDR = 0x6; // LSURV[7] LAUTO[6] LFLT[5:2] LTRH[1:0]
const uint8_t DAC_FIFOSTAT_ADDR = 0x7; // FIFOSTAT[7] FIFOPHASE[6:4] VALID[3] CHANGE[2] OFFSET[1:0]
