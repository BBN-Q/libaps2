...
// ACK .......Acknowledge Flag. Set in the Acknowledge Packet returned in
// response to a
// Command Packet. Must be zero in a Command Packet.
// SEQ............Set for Sequence Error. MODE/STAT = 0x01 for skip and 0x00 for
// duplicate.
// SEL........Channel Select. Selects target for commands with more than one
// target. Zero
// if not used. Unmodified in the Acknowledge Packet.
// R/W ........Read/Write. Set for read commands, cleared for write commands.
// Unmodified
// in the Acknowledge Packet.
// CMD<3:0> ....Specifies the command to perform when the packet is received by
// the APS
// module. Unmodified in the Acknowledge Packet. See section 3.8 for
// information on the supported commands.
// MODE/STAT<7:0> ....Command Mode or Status. MODE bits modify the operation of
// some
...
// information.
// CNT<15:0> ...Number of 32-bit data words to transfer for a read or a write
// command. Note
...
public:
  ...
  static vector<APS2Datagram> chunk(APS2Command, uint32_t,
                                    const vector<uint32_t> &, uint16_t);
