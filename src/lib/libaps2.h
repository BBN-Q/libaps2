...
EXPORT APS2_STATUS get_firmware_version(const char *, uint32_t *, uint32_t *,
                                        uint32_t *, char *);
...
EXPORT APS2_STATUS set_mixer_correction_matrix(const char *, float *);
EXPORT APS2_STATUS get_mixer_correction_matrix(const char *, float *);
...
EXPORT APS2_STATUS write_bitfile(const char *, const char *, uint32_t,
                                 APS2_BITFILE_STORAGE_MEDIA);
EXPORT APS2_STATUS program_bitfile(const char *, uint32_t);

EXPORT APS2_STATUS write_configuration_SDRAM(const char *, uint32_t, uint32_t *,
                                             uint32_t);
EXPORT APS2_STATUS read_configuration_SDRAM(const char *, uint32_t, uint32_t,
                                            uint32_t *);
